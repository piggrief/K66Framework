...
# define I2CWriteByte I2C_WriteAddr(I2C_0,
# define I2CReadByte I2C_ReadAddr(I2C_0,
...
# define delayMS(x) LPTMR_delay_ms(x) 
/**/
void ConfigMPU9250() {
  I2C_Init(I2C_0);
	// wake up device
	...
	unsigned char c = I2CReadByte MPU9250_ADDR, MPUREG_GYRO_CONFIG);
