...
#define MT9V032_COF_UART    UART_2  //配置摄像头所使用到的串口     
...
//--------------------------------------------------------------------------------------------------
#define MT9V032_PCLK                PTB1                            	//摄像头像素时钟
        
#define MT9V032_VSYNC               PTC                            	//摄像头场同步信号
...
#define MT9V032_DATAPORT 		PTC_BYTE1_IN	                //DMA数据口
