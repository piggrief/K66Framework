...
int16 MT9V032_CFG[CONFIG_FINISH][2]=
{
    ...
    {EXP_TIME,          3118},//3118, //曝光时间          摄像头收到后会自动计算出最大曝光时间，如果设置过大则设置为计算出来的最大曝光值
...
//{
//	uart_putchar(uart_2,0x00);uart_putchar(uart2,0xff);uart_putchar(uart2,0x01);uart_putchar(uart2,0x01);//发送命令
//    uart_putbuff(uart_2, (uint8_t *)image, ROW*COL);  //发送图像
//}
