...
#define ALT2     0x02 << PORT_PCR_MUX_SHIFT,
...
uint32 spi_init(SPIn_e spin, SPIn_PCSn_e pcs, SPI_CFG master,uint32 baud)
{
    ...
    {
    case SPI_0:
        SIM_SCGC6 |= SIM_SCGC6_SPI0_MASK;      //使能 SPI0 时钟

        if(SPI0_SCK == PTA15)
        {                    
            PORTA_PCR15= PORT_PCR_MUX(2);       //使能PTA15引脚第二功能，即SPI0_SCK 
        }
        else if(SPI0_SCK == PTC5)
        {
             PORTC_PCR5= PORT_PCR_MUX(2);       //PTC5
        }
        else if(SPI0_SCK == PTD1)
        {
             PORTD_PCR1= PORT_PCR_MUX(2);       //PTD1
        }        
        else
        {
            break;
        ...
        if(SPI0_SOUT == PTA16)
        {                    
            PORTA_PCR16= PORT_PCR_MUX(2);       //使能PTA16引脚第二功能，即SPI0_SOUT 
        }
        else if(SPI0_SOUT == PTC6)
        {
             PORTC_PCR6= PORT_PCR_MUX(2);       //PTC6
        }
        else if(SPI0_SOUT == PTD2)
        {
             PORTD_PCR2= PORT_PCR_MUX(2);       //PTD2
        }        
        else
        {
            break;
        ...
        if(SPI0_SIN == PTA17)
        {                    
            PORTA_PCR17= PORT_PCR_MUX(2);       //使能PTA17引脚第二功能，即SPI0_SIN 
        }
        else if(SPI0_SIN == PTC7)
        {
             PORTC_PCR7= PORT_PCR_MUX(2);       //PTC7
        }
        else if(SPI0_SIN == PTD3)
        {
             PORTD_PCR3= PORT_PCR_MUX(2);       //PTD3
        }        
        else
        {
            break;
        ...
        if(SPI0_PCS0 == PTA14)
        {                    
            PORTA_PCR14= PORT_PCR_MUX(2);       //使能PTA14引脚第二功能，即SPI0_PCS0 
        }
        else if(SPI0_PCS0 == PTC4)
        {
             PORTC_PCR4= PORT_PCR_MUX(2);       //PTC4
        }
        else if(SPI0_PCS0 == PTD0)
        {
             PORTD_PCR0= PORT_PCR_MUX(2);       //PTD0
        }        
        else
        {
            break;
        ...
        if(SPI0_PCS1 == PTC3)
        {
             PORTC_PCR3= PORT_PCR_MUX(2);       //PTC3
        }
        else if(SPI0_PCS1 == PTD4)
        {
             PORTD_PCR4= PORT_PCR_MUX(2);       //PTD4
        }        
        else
        {
            break;
        ...
        if(SPI0_PCS2 == PTC2)
        {
             PORTC_PCR2= PORT_PCR_MUX(2);       //PTC2
        }
        else if(SPI0_PCS2 == PTD5)
        {
             PORTD_PCR5= PORT_PCR_MUX(2);       //PTD5
        }        
        else
        {
            break;
        ...
        if(SPI0_PCS3 == PTC1)
        {
             PORTC_PCR1= PORT_PCR_MUX(2);       //PTC1
        }
        else if(SPI0_PCS3 == PTD6)
        {
             PORTD_PCR6= PORT_PCR_MUX(2);       //PTD6
        }        
        else
        {
            break;
        ...
        if(SPI0_PCS4 == PTC0)
        {
             PORTC_PCR0= PORT_PCR_MUX(2);       //PTC0
        }       
        else
        {
            break;
        ...
        if(SPI0_PCS5 == PTB23)
        {
             PORTB_PCR23= PORT_PCR_MUX(3);       //PTB233
        }           
        else
        {
            break;
    ...
    case SPI_1:
        SIM_SCGC6 |= SIM_SCGC6_SPI1_MASK;      //使能 SPI1 时钟

        if(SPI1_SCK == PTE2)
        {                    
            PORTE_PCR2= PORT_PCR_MUX(2);       //使能PTE2引脚第二功能，即SPI1_SCK 
        }
        else if(SPI1_SCK == PTB11)
        {
             PORTB_PCR11= PORT_PCR_MUX(2);       //PTB11
        }            
        else
        {
            break;
        ...
        if(SPI1_SOUT == PTE1)
        {                    
            PORTE_PCR1= PORT_PCR_MUX(2);       //使能PTE1引脚第二功能，即SPI1_SOUT 
        }
        else if(SPI1_SOUT == PTB16)
        {
             PORTB_PCR16= PORT_PCR_MUX(2);       //PTB16
        }             
        else
        {
            break;
        ...
        if(SPI1_SIN == PTB17)
        {                    
            PORTB_PCR17= PORT_PCR_MUX(2);       //使能PTB17引脚第二功能，即SPI1_SIN 
        }
        else if(SPI1_SIN == PTE3)
        {
             PORTE_PCR3= PORT_PCR_MUX(2);       //PTE3
        }            
        else
        {
            break;
        ...
        if(SPI1_PCS0 == PTB10)
        {                    
            PORTB_PCR10= PORT_PCR_MUX(2);       //使能PTB10引脚第二功能，即SPI1_PCS0 
        }
        else if(SPI1_PCS0 == PTE4)
        {
             PORTE_PCR4= PORT_PCR_MUX(2);       //PTE4
        }          
        else
        {
            break;
        ...
        if(SPI1_PCS1 == PTE0)
        {
             PORTE_PCR0= PORT_PCR_MUX(2);       //PTE0
        }
        else if(SPI1_PCS1 == PTB9)
        {
             PORTB_PCR9= PORT_PCR_MUX(2);       //PTB9
        }        
        else
        {
            break;
        ...
        if(SPI1_PCS2 == PTE5)
        {
             PORTE_PCR5= PORT_PCR_MUX(2);       //PTE5
        }      
        else
        {
            break;
        ...
        if(SPI1_PCS3 == PTE6)
        {
             PORTE_PCR6= PORT_PCR_MUX(2);       //PTE6
        }       
        else
        {
            break;
    ...
    case SPI_2:
        SIM_SCGC3 |= SIM_SCGC3_SPI2_MASK;      //使能 SPI2 时钟

        if(SPI2_SCK == PTD12)
        {                    
            PORTD_PCR12= PORT_PCR_MUX(2);       //使能PTD12引脚第二功能，即SPI2_SCK 
        }
        else if(SPI2_SCK == PTB21)
        {
             PORTB_PCR21= PORT_PCR_MUX(2);       //PTB21
        }            
        else
        {
            break;
        ...
        if(SPI2_SOUT == PTD13)
        {                    
            PORTD_PCR13= PORT_PCR_MUX(2);       //使能PTD13引脚第二功能，即SPI2_SOUT 
        }
        else if(SPI2_SOUT == PTB22)
        {
             PORTB_PCR22= PORT_PCR_MUX(2);       //PTB22
        }             
        else
        {
            break;
        ...
        if(SPI2_SIN == PTD14)
        {                    
            PORTD_PCR14= PORT_PCR_MUX(2);       //使能PTD14引脚第二功能，即SPI2_SIN 
        }
        else if(SPI2_SIN == PTB23)
        {
             PORTB_PCR23= PORT_PCR_MUX(2);       //PTB23
        }            
        else
        {
            break;
        ...
        if(SPI2_PCS0 == PTD11)
        {                    
            PORTD_PCR11= PORT_PCR_MUX(2);       //使能PTD11引脚第二功能，即SPI2_PCS0 
        }
        else if(SPI2_PCS0 == PTB20)
        {
             PORTB_PCR20= PORT_PCR_MUX(2);       //PTB20
        }          
        else
        {
            break;
        ...
        if(SPI2_PCS1 == PTD15)
        {
             PORTD_PCR15= PORT_PCR_MUX(2);       //PTD15
        }        
        else
        {
            break;
...
SPI_CLK_EXIT:
        fit_clk =  bus_clk_M*1000000/(Scaler[fit_br] * Prescaler[fit_pbr]);
